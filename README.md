...
In 2017, most of the stock return was positive except the TERP stock, but in 2018, the most of the stock return was negative except the ENPH and RUN stocks. 
...
The execution times of the original VBS script are less than the refactored script since some portions (for loops) were not completed so the computer took less time to run the results. 
